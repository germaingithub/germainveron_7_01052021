                                ...
                                <div class="col">
                                    <form v-on:submit.prevent="createPost" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <b-form-textarea name="title" type="text" v-model="title"
                                                class="form-control border-0" id="title" rows="2" placeholder="titre"
                                                required></b-form-textarea>
                                        </div>
                                        <div class="form-group mb-0">
                                            <label class="sr-only" for="content">Créer un post</label>
                                            <b-form-textarea name="content" type="text" v-model="content"
                                                class="form-control border-0" id="content" rows="2"
                                                placeholder="What's on you r mind today?" required></b-form-textarea>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col">
                                                <button
                                                    class="btn fluid btn-fposts btn-sm bg-danger text-dark font-weight-bold">Envoyer</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
